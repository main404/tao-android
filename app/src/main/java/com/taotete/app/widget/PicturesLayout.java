...
import com.taotete.app.model.Image;
...
public class PicturesLayout extends ViewGroup implements View.OnClickListener {
    ...
    public PicturesLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PicturesLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            final TypedArray a = context.obtainStyledAttributes(
                    attrs, R.styleable.PicturesLayout, defStyleAttr, defStyleRes);

            // Load clip touch corner radius
            vSpace = a.getDimensionPixelOffset(R.styleable.PicturesLayout_verticalSpace, vSpace);
            hSpace = a.getDimensionPixelOffset(R.styleable.PicturesLayout_horizontalSpace, hSpace);
            setColumn(a.getInt(R.styleable.PicturesLayout_column, 3));
            setMaxPictureSize(a.getDimensionPixelOffset(R.styleable.PicturesLayout_maxPictureSize, 0));
            a.recycle();
        }
    ...
    public void setImage(Image[] images) {
        ...
        if (images != null) {
            ...
            images = CollectionUtil.toArray(isOkImages, Image.class);
        }
        ...
        if (mImages != null && mImages.length > 0) {
            ...
            for (int i = 0; i < mImages.length; i++) {
                ...
                RequestBuilder builder = requestManager.load(path)
                        .apply(options);
    ...
    public void setImage(String[] images) {
        ...
        Image[] ims = new Image[images.length];
        for (int i = 0; i < images.length; i++) {
            ims[i] = Image.create(images[i]);
        }
        setImage(ims);
    }
    ...
    public void onClick(View v) {
        ...
        String[] paths = Image.getImagePath(images);
